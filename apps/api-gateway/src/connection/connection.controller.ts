...
import type { IConnectionSearchCriteria } from '../interfaces/IConnectionSearch.interface'
...
import type { GetAllAgentConnectionsDto, GetAllConnectionsDto } from './dtos/get-all-connections.dto'
import type { BasicMessageDto, QuestionAnswerWebhookDto, QuestionDto } from './dtos/question-answer.dto'
...
export class ConnectionController {
  ...
  async sendQuestion(
    ...
    @User() _reqUser: IUserRequestInterface,
    @Res() res: Response
  ): Promise<Response> {
  ...
  async getConnectionWebhook(
    ...
    if (orgId && connectionDto?.contextCorrelationId === 'default') {

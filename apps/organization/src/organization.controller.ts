...
export class OrganizationController {
   ...
   */
    ...
    async updateOrganization(payload: {updateOrgDto: IUpdateOrganization }): Promise<object> {
      return this.organizationService.updateOrganization(payload.updateOrgDto);
    }

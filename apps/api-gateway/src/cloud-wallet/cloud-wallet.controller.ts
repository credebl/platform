...
import type { CloudWalletService } from './cloud-wallet.service'
import type { AcceptProofRequestDto } from './dtos/accept-proof-request.dto'
import type {
  AcceptOfferDto,
  BasicMessageDTO,
...
import type { CloudBaseWalletConfigureDto } from './dtos/configure-base-wallet.dto'
import type { CreateConnectionDto } from './dtos/create-connection.dto'

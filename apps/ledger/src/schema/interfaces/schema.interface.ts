...
import type { JSONSchemaType, SchemaTypeEnum } from '@credebl/enum/enum'
import type { UserRoleOrgPermsDto } from '../dtos/user-role-org-perms.dto'
...
export interface SchemaWithOrgAndUser {
  attributes: string
  name: string
  alias: string
  createDateTime: Date
...
export interface ISchemasWithCount {
  schemasCount: number
  schemasResult: SchemaWithOrgAndUser[]
}

...
import type { IUserInvitations } from '@credebl/common/interfaces/user.interface'
import { Inject, Injectable } from '@nestjs/common'
import type { ClientProxy } from '@nestjs/microservices'
import type { user } from '@prisma/client'
import type { ICheckUserDetails, IUsersProfile } from 'apps/user/interfaces/user.interface'

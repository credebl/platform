...
export class NotificationController {
  ...
  async registerOrgWebhookEndpoint(
    ...
    const registerUserEndpoint =
      await this.notificationService.registerOrgWebhookEndpoint(registerOrgWebhhookEndpointDto);
  ...
  async sendNotification(
    ...
    this.logger.log(`[sendNotification] - Sending notification: ${JSON.stringify(notificationRequestBody)}`);
    const sendNotification = await this.notificationService.sendNotification(notificationRequestBody);

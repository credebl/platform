...
import type { ICredDefDetails, IPlatformCredDefsData } from '@credebl/common/interfaces/cred-def.interface'
import { MessagePattern } from '@nestjs/microservices'
import type { credential_definition } from '@prisma/client'
import type { CredentialDefinitionService } from './credential-definition.service'
import type {
...
import type { CreateCredDefPayload, GetCredDefPayload } from './interfaces/create-credential-definition.interface'
import type { CredDefSchema } from './interfaces/credential-definition.interface'
...
export class CredentialDefinitionController {
  ...
  @MessagePattern({ cmd: 'store-cred-def-record' })
  async getSchemaRecordBySchemaId(payload: SaveCredDefPayload): Promise<credential_definition> {
    return this.credDefService.storeCredDefRecord(payload.credDefDetails)
  }
}

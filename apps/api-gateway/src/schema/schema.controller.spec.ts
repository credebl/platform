...
describe('schemaController Test Cases', () => {
  ...
  describe('createSchema', () => {
    ...
    it('should return an expected schema', async () => {
      ...
      const result = await controller.createSchema(createSchemaDto, user)
    ...
    it('Should throw error when schema version is not string', async () => {
      ...
      const schemaVersionResult = plainToClassFromExist(CreateSchemaDto, schema_version_dto)
    ...
    it('Should throw error when schema name is not a string', async () => {
      ...
      const schemaNameResult = plainToClassFromExist(CreateSchemaDto, schemaName)
    ...
    it('should throw error when schema version is null', async () => {
      ...
      const schemaNameResult = plainToClassFromExist(CreateSchemaDto, schema_version_dto)
      const errors = await validate(schemaNameResult)
    ...
    it('should throw error when schema name is null', async () => {
      ...
      const schemaNameResult = plainToClassFromExist(CreateSchemaDto, schema_name_dto)
      const errors = await validate(schemaNameResult)
    ...
    it('should throw error when attributes are not in array', async () => {
      ...
      const schemaattributeResult = plainToClassFromExist(CreateSchemaDto, attribute_dto)
  ...
  describe('getSchemasByOrgId', () => {
    ...
    it('should return an expected schemas by org Id', async () => {
      const result = await controller.getSchemasByOrgId(page, search_text, items_per_page, sortValue, schemaSortBy, id)
      expect(result).toEqual({})
    })
  })
  ...
  describe('getSchemaBySchemaId', () => {
    ...
    const id = '1'
    it('should return an expected schemas by org Id', async () => {
      const result = await controller.getSchemaById(user, id)
      expect(result).toEqual({})
    })
  })

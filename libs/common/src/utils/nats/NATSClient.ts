...
import { ContextStorageService, ContextStorageServiceKey } from '../context/contextStorageService.interface';
import { v4 } from 'uuid';
...
export class NATSClient {
  ...
  sendNats(serviceProxy: ClientProxy, cmd: string, payload: any, limit?: {type?: string, limit?: number }): Promise<any> {

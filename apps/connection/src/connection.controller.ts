import type { IConnectionList, IDeletedConnectionsRecord } from '@credebl/common/interfaces/connection.interface'
...
import type { ConnectionService } from './connection.service' // Import the common service in connection module
import type {
  GetAllConnections,
  ICreateConnection,
...
import type { IQuestionPayload } from './interfaces/messaging.interfaces'
@Controller()

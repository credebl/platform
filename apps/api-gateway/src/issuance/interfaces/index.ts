import type { SchemaType } from '@credebl/enum/enum'
import type { JsonLdCredentialDetailCredentialStatus } from '../dtos/issuance.dto'
import type { JsonValue } from '../utils/helper'

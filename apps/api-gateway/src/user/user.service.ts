...
export class UserService extends BaseService {
  ...
  async getUserCredentialsById(credentialId: string): Promise<object> {
    ...
    return this.natsClient.sendNatsMessage(this.serviceProxy, 'get-user-credentials-by-id', payload);
  }
  ...
  async shareUserCertificate(
    shareUserCredentials: CreateCertificateDto
      ...
      return this.natsClient.sendNatsMessage(this.serviceProxy, 'share-user-certificate', shareUserCredentials);
  }

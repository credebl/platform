...
import type { IPlatformCredDefsData } from '@credebl/common/interfaces/cred-def.interface'
import type { INetworkUrl, ISchemaDetails } from '@credebl/common/interfaces/schema.interface'
import { Inject, Injectable } from '@nestjs/common'
import type { ClientProxy } from '@nestjs/microservices'
import { BaseService } from '../../../../libs/service/base.service'
import type { GetAllPlatformCredDefsDto } from '../credential-definition/dto/get-all-platform-cred-defs.dto'
import type { ILedgers, ISchemaSearchPayload } from '../interfaces/ISchemaSearch.interface'
